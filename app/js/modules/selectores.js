...
export const medicoModal = document.querySelector("#medico-modal");
...
// Modal Médico
export const modalMedicoSubmitBtn = document.querySelector("#update-medico");
export const modalMedicoInput     = document.querySelector(".form__input--modal--medico");
export const modalMedicoCloseBtn  = document.querySelector("#medico-modal .modal__close");
export const modalMedicoCancelBtn = document.querySelector("#medico-modal .modal__button--close");
